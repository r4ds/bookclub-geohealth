...
```{tikz figure1, echo = FALSE, fig.cap = "Likelihood", fig.ext = 'vsg', engine.opts = list(template = "standalone_1x5in.tex")}
\begin{equation*}
...
```{tikz figure2, echo = FALSE, fig.cap = "Prior distribution", fig.ext = 'vsg', engine.opts = list(template = "standalone_1x5in.tex")}
\begin{equation*}
...
```{tikz figure3, echo = FALSE, fig.cap = "Bayes's Theorem", fig.ext = 'vsg', engine.opts = list(template = "standalone_1x5in.tex")}
\begin{equation*}
...
```{tikz figure4, echo = FALSE,  fig.ext = 'vsg', engine.opts = list(template = "standalone_1x5in.tex")}
\begin{equation*}
